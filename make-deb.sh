#!/bin/bash
# Make Deb Package for darkshadow (^.^)
_PACKAGE=darkshadow
_VERSION=2.3.5
_ARCH="all"
...
Version: ${_VERSION}
Architecture: ${_ARCH}
Maintainer: @Umairboss1
Depends: ${_depend}
Homepage: https://github.com/Umairboss1/darkshadow
...
cp -fr .github/ .sites/ LICENSE README.md darkshadow.sh ./build_env/$_opt_dir
